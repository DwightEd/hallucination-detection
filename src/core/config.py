...
class ModelConfig(BaseModel, extra="forbid"):
    ...
    Attributes:
        ...
        hidden_size: Hidden dimension size (auto-detected from model)
        context_size: Maximum context length (default: 8192)
        
        dtype: Data type. Options: 'float16', 'bfloat16', 'float32'
        device_map: Device mapping. Options: 'auto', 'cuda', 'cpu', 'balanced'
        trust_remote_code: Whether to trust remote code (default: True)
        attn_implementation: Attention implementation. Must be 'eager' for extraction.
        
        load_in_4bit: Enable 4-bit quantization (default: False)
        load_in_8bit: Enable 8-bit quantization (default: False)
        
        tokenizer_name: Tokenizer name if different from model (optional)
...
class FeaturesConfig(BaseModel, extra="forbid"):
    ...
    Attributes:
        ...
        hidden_states_pooling: Pooling method. Options: 'last_token', 'mean', 'max'
...
class MethodConfig(BaseModel, extra="forbid"):
    ...
    Attributes:
        ...
        required_features: Required features for this method (optional)
    """
    name: str = "lapeigvals"
    cls_path: Optional[str] = None
    ...
    required_features: Optional[Dict[str, bool]] = None  # NEW: Explicit feature requirements
