#!/bin/bash
# =============================================================================
# Llama-2-7b-chat: 跳过特征提取，直接训练和评估所有方法
# =============================================================================
# 前提条件：特征文件已存在于:
#   outputs/features/ragtruth/Llama-2-7b-chat-hf/seed_42/{task_type}/
#   outputs/features/ragtruth/Llama-2-7b-chat-hf/seed_42/{task_type}_test/
#
# 用法:
#   chmod +x run_train_eval_llama2.sh
#   ./run_train_eval_llama2.sh
# =============================================================================
